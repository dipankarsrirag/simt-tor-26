...
Output: /g/data/ba39/dipankar/simt-tor-26/results/phase2/tokenizer-extended-v6
"""
from pathlib import Path
from transformers import AutoTokenizer

SRC_TOK = "/g/data/po67/dipankar/models/gemma-4-E2B-it"
OUT_DIR = Path("/g/data/ba39/dipankar/simt-tor-26/results/phase2/tokenizer-extended-v6")
