...
model (dir: `results/train/{tag}/final`). Cond-A (GPT-4 chunks) and
...
def compute_laal(g_words: List[int], x_len: int, y_len: int) -> Optional[float]:
    ...
    be compared to ours — see docs/experiments.md 'Cross-paper
...
def main():
    ...
    ap.add_argument("--model_dir", required=True,
                    help="e.g. results/train/{tag}/final (OT-SFT, our method).")
